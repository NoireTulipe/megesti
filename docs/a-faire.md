**Réseau**
Salon : Ajouter période habituelle; Durée en jours; Prix prévue (fixe et %); type (salon, festival, marché, marché de noel (liste éditable), contact (nom, prenom, email, téléphone) plusieurs possible), (Adresse : Pays, ville, adresse), commentaires, note (en étoile), liste des chiffre d'affaire avec lien vers détails. => faits.
...
Pour les articles : Ajouter un switch : en vente/pas en vente (à renommer bien entendu)