...
Stocks : Sortie de stocks pour dépot-vente en librairie. 

Dépôt librairie : Ajouter la commission fixe ou pourcentage. Liste des livres en dépôt. Confirmer la vente de X livre => Ajouter ces ventes dans le bilan. Modifier les contacts par l'ajout de contact avec nom, numéro de téléphone, adresse mail. Liste pouvant contenir plusieurs contact. Les livres vendues ici doivent alimenter les bilans compta.

Préparer la limite de produits à vendre : Elle sera paramétrable dans l'admin selon le niveau du compte.
