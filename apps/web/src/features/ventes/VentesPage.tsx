...
const MODE_META: Record<string, { label: string; color: string }> = {
  ...
  ESPECES:  { label: 'EspÃ¨ces',  color: '#6B8F71' },
  CHEQUE:   { label: 'ChÃ¨que',   color: '#C9933A' },
...
export function VentesPage() {
  ...
  // â”€â”€ Articles / Rayon â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const [selectedRayonId, setSelectedRayonId] = useState<string | null>(null)
  const [search,          setSearch]          = useState('')

  // â”€â”€ Panier â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Bilan â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const [showBilan, setShowBilan] = useState(false)

  // â”€â”€ Annulation vente â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const [annulerConfirmId, setAnnulerConfirmId] = useState<string | null>(null)

  // â”€â”€ AccordÃ©ons â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const [fraisOpen,  setFraisOpen]  = useState(false)
  const [ventesOpen, setVentesOpen] = useState(false)

  // â”€â”€ Frais â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ MÃ©triques en temps rÃ©el de la session active â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Cart helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // Si le PDV encaisse lui-mÃªme, le mode est toujours PDV
  ...
  // Ã‰CRAN DE SÃ‰LECTION DE SESSION (+ historique)
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  if (!activeSession) {
    return (
      <div className={styles.page}>
        ...
        {mainTab === 'caisse' && (
          <div className={styles.sessionSelectPage}>
                    ...
                    <button key={s.id} className={styles.sessionCard} onClick={() => setActiveSessionId(s.id)}>
                      ...
                      <div className={styles.sessionCardBody}>
                        ...
                        <span className={styles.sessionCardMeta}>
                          Ouverte le {fmtDate(s.dateOuverture)} Ã  {fmtTime(s.dateOuverture)}
                          {s._count ? ` Â· ${s._count.ventes} vente${s._count.ventes > 1 ? 's' : ''}` : ''}
                        </span>
                      </div>
                      <span className={styles.sessionCardArrow}>â†’</span>
                    </button>
                  ))}
                </div>
                <p className={styles.sessionSelectOr}>â€” ou â€”</p>
              </>
            ) : pdvList.length === 0 ? (
            ...
            {/* Bouton "Ouvrir une session" â€” masquÃ© si pas de PDV (la mascotte gÃ¨re la navigation) */}
            {pdvList.length > 0 && (
              <button className={styles.btnPrimary} onClick={() => setShowOpenModal(true)}>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
                  <line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/>
          ...
          <div className={styles.historiqueContainer}>
            <div className={styles.historiqueTabBar}>
              <button className={`${styles.historiqueTab} ${historiqueTab === 'sessions' ? styles.historiqueTabActive : ''}`}
                onClick={() => setHistoriqueTab('sessions')}>Sessions fermÃ©es</button>
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  // Ã‰CRAN CAISSE ACTIVE
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  return (
    <div className={styles.page}>

      {/* â”€â”€ Barre session â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <div className={styles.sessionBar}>
        <div className={styles.sessionBarLeft}>
          ...
          {activeSession.nom && <span className={styles.sessionBarNom}>â€” {activeSession.nom}</span>}
          ...
          <div className={styles.sessionMetrics}>
            <div className={styles.sessionMetric}>
              ...
              <span className={styles.sessionMetricVal}>
                {sessionStats.caTTC.toLocaleString('fr-FR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} â‚¬
              </span>
            </div>
            {sessionStats.benefice !== null && (
              <>
                ...
                <div className={styles.sessionMetric}>
                  <span className={styles.sessionMetricLabel}>BÃ©nÃ©fice HT</span>
                  <span className={styles.sessionMetricVal}
                    style={{ color: sessionStats.benefice >= 0 ? '#166534' : '#991b1b', fontWeight: 800 }}>
                    {sessionStats.benefice >= 0 ? '+' : ''}
                    {sessionStats.benefice.toLocaleString('fr-FR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} â‚¬
                  </span>
                </div>
              </>
            )}
      ...
      {/* â”€â”€ Contenu POS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <div className={styles.body}>

        {/* â”€â”€ Panel gauche : articles â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          ...
          <div className={styles.articleGrid}>
            {filteredArticles.map((a) => (
              <button key={a.id} className={styles.articleTile} onClick={() => addToCart(a)}>
                ...
                <span className={styles.tilePrix}>{Number(a.prixVenteHT).toFixed(2)} â‚¬</span>
                <span className={stockClass(a)}>Stock : {a.stock}</span>
              </button>
            ))}
            {filteredArticles.length === 0 && (
              <p className={styles.noArticles}>Aucun article{search ? ` pour Â« ${search} Â»` : ''}.</p>
            )}
          </div>
        </div>

        {/* â”€â”€ Panel droit : panier â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
                        ...
                        {editPrixId === l.articleId ? (
                          <div className={styles.prixEditRow}>
                            <input
                              ...
                              autoFocus
                            />
                            <button className={styles.prixEditSave} onClick={() => confirmPrixEdit(l.articleId)}>âœ“</button>
                            <button className={styles.prixEditCancel} onClick={() => { setEditPrixId(null); setEditPrixVal('') }}>âœ•</button>
                          </div>
                        ) : (
                          <button
                          ...
                          >
                            {hasRemise && (
                              <span className={styles.prixOriginal}>{l.prixUnitaireHT.toFixed(2)} â‚¬</span>
                            )}
                            <span className={hasRemise ? styles.prixRemise : styles.prixNormal}>
                              {prixAff.toFixed(2)} â‚¬
                            </span>
                            <span className={styles.editPrixIcon}>âœŽ</span>
                          </button>
                        )}
                        <span className={styles.cartLineSubtotal}>
                          {(prixAff * l.quantite).toFixed(2)} â‚¬
                        </span>
                      </div>
                    </div>
                  )
            ...
            {franchiseTVA ? (
              <>
                <div className={styles.totalRow} style={{ color: 'var(--text-soft)', fontSize: '0.72rem' }}>
                  <span>TVA non applicable â€” art. 293 B CGI</span>
                </div>
                <div className={styles.totalRowBig}><span>Total</span><span>{totals.ttc} â‚¬</span></div>
              </>
            ) : (
              <>
                <div className={styles.totalRow}><span>Total HT</span><span>{totals.ht} â‚¬</span></div>
                <div className={styles.totalRow}><span>TVA</span><span>{totals.tva} â‚¬</span></div>
                <div className={styles.totalRowBig}><span>Total TTC</span><span>{totals.ttc} â‚¬</span></div>
              </>
            )}
          </div>
          ...
          <div className={styles.payment}>
            {pdvEncaisse ? (
              <div className={styles.pdvEncaisseBadge}>
                ...
                <div>
                  <p className={styles.pdvEncaisseTitle}>EncaissÃ© par le point de vente <HelpButton slug="aide-caisse-paiementpointdevente" className={styles['tab-help']} /></p>
                  <p className={styles.pdvEncaisseSub}>Le paiement sera reversÃ© ultÃ©rieurement.</p>
                </div>
              </div>
            ) : (
              <>
            ...
            >
              {createVente.isPending ? 'Enregistrementâ€¦' : `Valider â€” ${totals.ttc} â‚¬`}
            </button>
          </div>
        </div>
      </div>

      {/* â”€â”€ Frais de session â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
        ...
        >
          ...
          {fraisSession.filter(f => f.actif).length > 0 && (
            <span className={styles.sectionAccTotal}>
              {fraisSession.filter(f => f.actif).reduce((s, f) => s + (f.montantHT ? parseFloat(f.montantHT) : 0), 0).toFixed(2)} â‚¬ HT
            </span>
          )}
          <span className={styles.sectionAccChevron} style={{ transform: fraisOpen ? 'rotate(180deg)' : undefined }}>â–¾</span>
        </button>
          ...
          <div className={styles.sectionAccBody}>
            <div className={styles.fraisBodyHeader}>
              <button className={styles.btnAddFrais} onClick={() => setShowFraisForm(v => !v)}>
                {showFraisForm ? 'âœ• Annuler' : '+ Enregistrer un frais'}
              </button>
              ...
              <div className={styles.fraisForm}>
                ...
                <div className={styles.fraisInputRow}>
                  <input
                    ...
                    placeholder="Motif (ex : A7 â†’ salle, pÃ©age retour)"
                    value={fraisMotif}
                  ...
                  <div className={styles.fraisMontantWrap}>
                    ...
                    />
                    <span className={styles.fraisMontantUnit}>â‚¬ HT</span>
                  </div>
                  <button
                  ...
                  >
                    {createFrais.isPending ? 'â€¦' : 'Ajouter'}
                  </button>
                </div>
              </div>
            )}
                ...
                {fraisSession.map(f => (
                  <div key={f.id} className={`${styles.fraisRow} ${!f.actif ? styles.fraisRowDeleted : ''}`}>
                    ...
                    <span className={styles.fraisMontant}>
                      {f.montantHT ? `${parseFloat(f.montantHT).toFixed(2)} â‚¬ HT` : 'â€”'}
                    </span>
                    {f.actif ? (
                      <button className={styles.btnDeleteFrais} onClick={() => deleteFrais.mutate(f.id)} title="Supprimer">âœ•</button>
                    ) : (
                      <span className={styles.fraisAnnule}>annulÃ©</span>
                    )}
                  </div>
                ))}
            ...
            {fraisSession.length === 0 && !showFraisForm && (
              <p className={styles.fraisEmpty}>Aucun frais enregistrÃ© pour cette session.</p>
            )}
          </div>
        )}
      </div>

      {/* â”€â”€ Ventes de la session â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <div className={styles.ventesSection}>
        <button className={styles.sectionAccHead} onClick={() => setVentesOpen(o => !o)}>
          ...
          <span className={styles.sectionAccChevron} style={{ transform: ventesOpen ? 'rotate(180deg)' : undefined }}>â–¾</span>
        </button>

        {ventesOpen && (
          <div className={styles.sectionAccBody}>
            {ventes.length === 0 && (
              <p className={styles.fraisEmpty}>Aucune vente enregistrÃ©e pour cette session.</p>
            )}
            {ventes.map(v => {
              ...
              return (
                <div key={v.id} className={`${styles.venteSessionRow} ${annulee ? styles.venteSessionRowAnnulee : ''}`}>
                  <div className={styles.venteSessionLeft}>
                    ...
                    {annulee
                      ? <span className={styles.venteAnnuleeBadge}>AnnulÃ©e</span>
                    ...
                    <div className={styles.venteSessionArticles}>
                      {v.lignes.map(l => (
                        <span key={l.id} className={styles.venteSessionPill}>
                          {l.article.nom}{l.quantite > 1 ? ` Ã—${l.quantite}` : ''}
                        </span>
                      ))}
                    </div>
                  </div>
                  <div className={styles.venteSessionRight}>
                    <span className={styles.venteSessionMontant}>
                      {parseFloat(v.totalTTC).toFixed(2)} â‚¬
                    </span>
                    {!annulee && (
      ...
      {/* â”€â”€ Modale bilan â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {showBilan && (
        ...
        <div className={styles.modalForm}>
          <p className={styles.modalText}>
            ...
            {ventes.filter((v) => v.statut === 'VALIDEE').length > 0 && (
              <> {ventes.filter((v) => v.statut === 'VALIDEE').length} vente(s) enregistrÃ©e(s).</>
            )}
          </p>
          <div>
            <label className={styles.modalLabel}>Fond de caisse en fin de session (â‚¬)</label>
            <input
...
// â”€â”€ Composant modal ouverture (partagÃ© entre les deux Ã©crans) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      <div className={styles.modalForm}>
        <div>
          ...
          >
            ...
            {salons.length > 0 && (
              <optgroup label="Salons &amp; Ã©vÃ©nements">
                {salons.map((p) => <option key={p.id} value={p.id}>ðŸŽª {p.nom}</option>)}
              </optgroup>
            )}
            {fixes.length > 0 && (
        ...
        <div>
          ...
          <input
            ...
            placeholder="Ex : Vendeur A â€” Jour 1"
            className={styles.modalInput}
          />
        </div>
        <div>
          <label className={styles.modalLabel}>Fond de caisse (â‚¬)</label>
          <input
        ...
        <label className={styles.modalCheckLabel}>
          ...
          />
          <span>
            DÃ©biter le stock de la ME
            <small className={styles.modalHint}>DÃ©cocher si le vendeur gÃ¨re son propre stock.</small>
          </span>
        </label>
        <div className={styles.modalActions}>
